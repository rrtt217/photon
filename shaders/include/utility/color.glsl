...
#else
    #define display_eotf(x) srgb_eotf_hq_safe(min(x, HdrGamePeakBrightness / HdrGamePaperWhiteBrightness) * working_to_display_color)
    // #define display_eotf_inv(x) //TODO: create if used
#endif

// Aproximate sRGB gamma
